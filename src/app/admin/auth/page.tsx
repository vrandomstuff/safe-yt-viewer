...
export async function digestMessage(message: string): Promise<string> { // thank you mdn
...
export default function Page() {
	...
	return (
		...
		<button onClick={async () => {
			...
			const element = document.getElementById("secretInput") as HTMLInputElement
			if(window.isSecureContext) {
				...
				console.log("This is not a secure context so we are sending the raw secret")
